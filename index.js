...
bot.on('guildMemberAdd', member => {
  member.guild.channels.get("ID-UL LA CANAL VOICE AICI").setName(`🌐 Total Membrii: ${member.guild.memberCount}`)

  member.guild.channels.get("ID-UL LA CANAL VOICE AICI").setName(`👤 Newest: ${member.user.username}`)

  member.guild.channels.get("ID-UL LA CANAL VOICE AICI").setName(`⭐ Goal: ${member.guild.memberCount}/100`)
